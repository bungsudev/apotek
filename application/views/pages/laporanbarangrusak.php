<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800 text-center">Laporan Obat Rusak</h1>
...
<script>
    $(document).ready(function() {
        ...
        $('#filterButton').click(function() {
            window.location.href = "<?= base_url() ?>laporan/laporanbarangrusak/" + $('#date1').val() + "/" + $('#date2').val();
        })

        $('.printButton').click(function() {
            window.location.href = "<?= base_url() ?>laporan/cetaklaporanbarangrusak/" + $('#date1').val() + "/" + $('#date2').val();
        })
