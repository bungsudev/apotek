...
<body>
    ...
    <table style="width: 100%; ">
        <tr>
            ...
            <td align="center" style=""> <span class="font1" style="font-weight : bold; text-align:center "> <b>Laporan Pembelian </b><br>
    ...
    <table style="width: 100%; border:none !important">
        <tr>
            <td style="text-align: center;    width: 100%">
                <p class="font4">Laporan Pembelian
    ...
    <table class="border" style="width: 100%;border:1px solid black;" cellspacing="0">
        <thead>
            <tr style="border:1px solid black;background-color: #521746;color:#fff;width:100%">
                <th style="width:25%">Id Pembelian</th>
    ...
    <page_footer>
        <table style="width: 100%; ">
            <tr>
                <td style="text-align: left;    width: 50%">Laporan Pembelian</td>
