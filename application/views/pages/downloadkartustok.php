...
<body>
    ...
    <table style="width: 100%; ">
        <tr>
            ...
            <td align="center" style=""> <span class="font1" style="font-weight : bold; text-align:center "> <b>Laporan Kartu Stok </b><br>
    ...
    <table style="width: 100%; border:none !important">
        <tr>
            <td style="text-align: center;    width: 100%">
                <p class="font4">Laporan Kartu Stok "<?= $obat['nama_obat'] ?>"
        ...
        <tbody>
            <?php
                                                                                                                                    ...
                                                                                                                                    foreach ($report as $row) {
                                                                                                                                        ...
                                                                                                                                        echo '
                    <tr>
                        <td>' . date_format(date_create($row['tanggal']), "d-F-Y h:i:s") . '</td>
    ...
    <page_footer>
        <table style="width: 100%; ">
            <tr>
                <td style="text-align: left;    width: 50%">Laporan Kartu Stok <?= $obat['nama_obat'] ?></td>
