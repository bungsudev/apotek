<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800 text-center">Laporan Retur Obat</h1>
                    ...
                    <div class="container p-3">
                        <table class="table table-striped table-bordered" id="dataTable" style="width:100%">
                            ...
                            <tfoot class="bg-primary text-white">
                                <tr>
                                    <th colspan="2">Total Retur Obat</th>
        ...
        <?php } else { ?>
            <div class="col-xl-12 col-lg-12">
                <div class="alert alert-warning">
                    Maaf data barang rusak tanggal
...
<script>
    $(document).ready(function() {
        ...
        $('#filterButton').click(function() {
            window.location.href = "<?= base_url() ?>laporan/laporanretur/" + $('#date1').val() + "/" + $('#date2').val();
        })

        $('.printButton').click(function() {
            window.location.href = "<?= base_url() ?>laporan/cetaklaporanreturobat/" + $('#date1').val() + "/" + $('#date2').val();
        })
