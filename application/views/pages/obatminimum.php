...
<div class="container-fluid" id="adminObat">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-2 text-gray-800">Obat Stok Minimum</h1>
    </div>
    <?php
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">List Obat Stok Minimum</h6>
        </div>
        <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        function getListObat() {
            $('.loading').show();
            $.ajax({
                url: "<?php echo base_url(); ?>obatminimum/obatminimum_fetch",
                method: "POST",
